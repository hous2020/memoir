...
```text
xlsum  -> csebuetnlp/xlsum, donnees francaises (~10k exemples)
mlsum  -> reciTAL/mlsum, donnees francaises (~200k exemples)
all    -> combine xlsum et mlsum pour l'entrainement (~210k exemples)
```
...
### Datasets augmentés
- **XLSUM**: 1 fichier d'entraînement (~10k exemples)
- **MLSUM**: 3 fichiers d'entraînement (~200k exemples)
- **ALL**: Combine XLSUM + MLSUM pour ~210k exemples disponibles
